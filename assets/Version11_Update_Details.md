...
Life label updates:
5. The life labels for CALB dataset are corrected: We observed that labeles of some CALB batteries were computed wrongly in v10 while they should be correct in the earlier versions.